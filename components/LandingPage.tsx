  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      >
        ...
        >
          <motion.pre 
            className="text-[8px] sm:text-[10px] md:text-xs text-[#00ff88] mono-font mb-12 leading-tight text-center opacity-80 pointer-events-none select-none"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.6 }}
          >
            {asciiLogo}
          ...
          <div className="text-center mb-16 relative w-full">
            ...
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-black mb-4 tracking-tighter heading-font uppercase text-white drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
              AUDIT <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00ff88] to-[#00ffee]">CRITICAL</span>
              <br />
              <span className="text-[#ff0055] italic">NO MERCY.</span>
            </h1>
            <p className="text-gray-400 text-lg sm:text-2xl mono-font max-w-xl mx-auto uppercase tracking-wider">
              {savageMode ? (
                ...
                <>PREPARE FOR <span className="text-white font-black">ABSOLUTE</span> TRUTH.</>
              )}
            </p>
          </div>
          ...
          <div className="w-full max-w-2xl relative">
                ...
                <div className="flex flex-col sm:flex-row">
                  <div className="relative flex-1 group">
                    ...
                    <input
                      ...
                      placeholder={savageMode ? "LOCKED_ON..." : `USER_TARGET... (${examples[placeholderIndex]})`}
                      className="w-full pl-16 pr-6 py-8 bg-transparent text-white text-xl sm:text-2xl font-black mono-font focus:outline-none transition-all placeholder:text-gray-800 uppercase"
                      autoFocus
                    />
                  </div>
                  ...
                  <button
                    ...
                    disabled={!input.trim()}
                    className="
                      px-10 py-6 sm:py-0 bg-[#00ff88] text-black font-black text-xl heading-font uppercase 
                  ...
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      INITIATE <Zap className={`w-5 h-5 fill-current transition-transform duration-300 ${isFocused ? 'scale-125' : ''}`} />
                    </span>
                    <motion.div 
                ...
                {isFocused && (
                  ...
                  >
                    <span className="text-[10px] mono-font text-gray-500 uppercase tracking-[0.2em] italic">
                      PRESS ENTER TO BEGIN EGO DECONSTRUCTION
                    </span>
                  </motion.div>
                )}
              </AnimatePresence>
            ...
            <div className="mt-20 flex flex-wrap justify-center gap-10 opacity-30 hover:opacity-100 transition-opacity duration-500">
